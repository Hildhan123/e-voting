                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        @csrf
                                        <div class="row mb-3">
                                            <label for="email" class="col-md-9 col-form-label text-md-end">{{ __('Email Address') }}</label>
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                    <small>Belum punya akun?</small> <a class="small" href="{{ route('register') }}">Buat Akun Sekarang</a>
                                    </div>
                                </div>
                            </div>
                        </div>
