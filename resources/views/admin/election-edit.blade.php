                    ...
                    <form action="{{ route('adminElectionUpdate', ['id' => $election->id]) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" class="form-control @error('gender') is-invalid @enderror">
                                <option value="laki_laki" {{ old('gender', $election->gender) === 'laki_laki' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="perempuan" {{ old('gender', $election->gender) === 'perempuan' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                            @error('gender')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
